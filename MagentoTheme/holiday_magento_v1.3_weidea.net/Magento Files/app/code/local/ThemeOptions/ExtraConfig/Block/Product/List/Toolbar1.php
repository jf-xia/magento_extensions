 ...
 */
class ThemeOptions_ExtraConfig_Block_Product_List_Toolbar1 extends Mage_Core_Block_Template
{
    /**
     * Products collection
     *
    ...
    public function getDefaultPerPageValue()
    {
        if ($this->getCurrentMode() == 'list') {
            if (Mage::helper("ExtraConfig")->themeOptions('default_product') == 10){
                if ($default = 10) {
                    return $default;
                }
            } elseif (Mage::helper("ExtraConfig")->themeOptions('default_product') == 15){
                if ($default = 15) {
                    return $default;
                }
            } elseif (Mage::helper("ExtraConfig")->themeOptions('default_product') == 20){
                if ($default = 20) {
                    return $default;
                }
            }
    ...
    {
        if ($this->getCurrentMode() == 'list') {
            return array(10=>10,15=>15,20=>20);
        }
        elseif ($this->getCurrentMode() == 'grid') {
            return array(10=>10,15=>15,20=>20);
        }
    ...
    {
        $pagerBlock = $this->getChild('product_list_toolbar1_pager');
