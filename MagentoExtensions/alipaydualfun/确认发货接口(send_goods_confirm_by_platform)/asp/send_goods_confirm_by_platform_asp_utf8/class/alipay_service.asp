...
Class AlipayService
	...
	Public Function Send_goods_confirm_by_platform(sParaTemp,sParaNode)
		
		'获取支付宝的返回XML处理结果
		Set  objSubmit = New AlipaySubmit
		sParaXml = objSubmit.SendGetInfo(sParaTemp, key, sign_type, input_charset, GATEWAY_NEW, sParaNode)
		'sParaXml = objSubmit.BuildFormHtml(sParaTemp, key, sign_type, input_charset, GATEWAY_NEW, "get", "确认")
