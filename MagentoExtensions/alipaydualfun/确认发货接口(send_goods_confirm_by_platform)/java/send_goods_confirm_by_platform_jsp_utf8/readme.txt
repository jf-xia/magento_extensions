  ...
  │        ╰───────────────────────╯            │
　│                                                                      │
　│     接口名称：确认发货接口（send_goods_confirm_by_platform）         │
　│　   代码版本：3.2                                                    │
  │     开发语言：JAVA                                                   │
  │     版    权：支付宝（中国）网络技术有限公司                         │
　│     制 作 者：支付宝商户事业部技术支持组                             │
...
send_goods_confirm_by_platform_jsp_utf8
  │
  ├src┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈类文件夹
  │  │
  │  ├com.alipay.config
  ...
  ├WebRoot┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈页面文件夹
  │  │
  │  ├send_goods_confirm_by_platform.jsp ┈支付宝接口入口文件
  │  │
  │  ├index.jsp┈┈┈┈┈┈┈┈┈┈┈┈┈┈支付宝调试入口页面
  │  │
  │  └WEB-INF
...
需要配置的文件是：
alipay_config.jsp、
index.jsp、send_goods_confirm_by_platform.jsp
