...
$aliapy_config['return_url']   = 'http://127.0.0.1/trade_create_by_buyer_php_gb/return_url.php';

//服务器异步通知页面路径，要用 http://格式的完整路径，不允许加?id=123这类自定义参数
$aliapy_config['notify_url']   = 'http://www.xxx.com/trade_create_by_buyer_php_gb/notify_url.php';
