...
$installer->addAttribute('customer','phonenumber', $attribute);

$attributes  = array('phonenumber' => $attribute);
...
$result = $installer->getConnection()->raw_fetchRow("SHOW COLUMNS from {$this->getTable('sales_flat_quote')} like '%customer_phonenumber%'");
