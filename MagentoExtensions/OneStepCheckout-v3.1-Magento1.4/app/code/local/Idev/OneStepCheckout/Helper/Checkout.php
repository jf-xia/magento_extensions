...
class Idev_OneStepCheckout_Helper_Checkout extends Mage_Core_Helper_Abstract
{
    ...
    function __construct()
    {
       ...
       // $this->temp = Mage::getStoreConfig('onestepcheckout/general/' . base64_decode('c2VyaWFs'));//c2VyaWFs=serial
    }
...
/*
    ...
    {
        //$key = sha1(base64_decode('b25lc3RlcGNoZWNrb3V0'));//b25lc3RlcGNoZWNrb3V0=onestepcheckout
