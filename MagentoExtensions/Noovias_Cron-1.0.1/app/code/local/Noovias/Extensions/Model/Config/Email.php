<?php
/**
 * Noovias_Extensions_Model_Config_Email
 *  *
 * NOTICE OF LICENSE
 *
 ...
 *
 * @todo why do we need an Abstract Class for Sending Emails?
 */
class Noovias_Extensions_Model_Config_Email
    extends Noovias_Extensions_Model_Config_Email_Abstract
{
    /**
    ...
    {
        $logFileName = $this->getData(self::CONFIG_KEY_LOGFILENAME);
        if (null === $logFileName) {
            $logFileName = self::LOGFILE_NAME_DEFAULT;
        }
        return $logFileName;
    }
}