<?php
/**
 * Noovias_Cron_Model_Mysql4_ProcessedJobs_Collection
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class Noovias_Cron_Model_Mysql4_Processedjob_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    /**
     * @return void
     */
