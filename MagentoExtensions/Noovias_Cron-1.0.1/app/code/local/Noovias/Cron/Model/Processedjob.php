<?php
/**
 * Noovias_Cron_Model_ProcessedJob
 *
 * NOTICE OF LICENSE
 *
 ...
 * @method setScheduleId(int $schedule_id)
 * @method boolean getEmailSent()
 * @method setEmailSent(boolean $email_sent)
 */
class Noovias_Cron_Model_Processedjob extends Mage_Core_Model_Abstract
{
    /**
     * @return void
     */
    ...
    {
        $this->_init('noovias_cron/processedjob');
    }
}
