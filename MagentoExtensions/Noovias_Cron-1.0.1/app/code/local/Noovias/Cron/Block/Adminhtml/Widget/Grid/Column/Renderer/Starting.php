<?php
/**
 * Noovias_Cron_Block_Adminhtml_Widget_Grid_Column_Renderer_Starting
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class Noovias_Cron_Block_Adminhtml_Widget_Grid_Column_Renderer_Starting
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    ...
    {
        $starting = Mage::helper('noovias_cron')->getStartingIn($row);
