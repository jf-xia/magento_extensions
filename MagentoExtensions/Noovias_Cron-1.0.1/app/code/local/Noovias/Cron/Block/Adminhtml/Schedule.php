<?php
/**
 * Noovias_Cron_Block_Adminhtml_Schedule
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class Noovias_Cron_Block_Adminhtml_Schedule extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
     *
     */
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('noovias_cron')->__('Noovias - Cronjobs - Schedule');
