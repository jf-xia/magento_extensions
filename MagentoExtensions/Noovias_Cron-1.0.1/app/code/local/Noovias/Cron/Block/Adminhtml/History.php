 ...
 */
class Noovias_Cron_Block_Adminhtml_History extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    /**
     *
     */
    public function __construct()
    {
        ...
        $this->_headerText = Mage::helper('noovias_cron')->__('Noovias - Cronjobs - History');
