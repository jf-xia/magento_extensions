<?php
/**
 * Noovias_Cron_Block_Adminhtml_Schedule_Edit
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class Noovias_Cron_Block_Adminhtml_Schedule_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    /**
     *
     */
    ...
    public function getHeaderText()
    {
        ...
        if ($schedule && $schedule->getId()) {
            return Mage::helper('noovias_cron')
                    ->__("Edit Item '%s'", $this->__($this->escapeHtml($schedule->getJobCode())));
        }
        else {
