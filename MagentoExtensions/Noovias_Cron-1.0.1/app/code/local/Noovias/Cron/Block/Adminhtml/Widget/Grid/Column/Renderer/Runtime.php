<?php
/**
 * Noovias_Cron_Block_Adminhtml_Widget_Grid_Column_Renderer_Runtime
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class Noovias_Cron_Block_Adminhtml_Widget_Grid_Column_Renderer_Runtime
    extends Mage_Adminhtml_Block_Widget_Grid_Column_Renderer_Abstract
{
    ...
    {
        $time = Mage::helper('noovias_cron')->getRuntime($row);
