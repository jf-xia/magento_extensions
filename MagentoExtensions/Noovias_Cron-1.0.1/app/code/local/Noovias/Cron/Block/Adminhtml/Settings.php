<?php
/**
 * Noovias_Cron_Block_Adminhtml_Settings
 *
 * NOTICE OF LICENSE
 *
 ...
 */
class Noovias_Cron_Block_Adminhtml_Settings extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct()
    {
        $this->_blockGroup = 'noovias_cron';
        $this->_controller = 'adminhtml_settings';
        $this->_headerText = Mage::helper('noovias_cron')->__('Noovias - Cronjobs - Settings');
