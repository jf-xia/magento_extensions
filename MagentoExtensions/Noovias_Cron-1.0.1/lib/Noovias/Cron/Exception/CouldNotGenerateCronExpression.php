<?php
/**
 * Noovias_Cron_Exception_CouldNotGenerateCronExpression
 *
 * NOTICE OF LICENSE
 *
...
class Noovias_Cron_Exception_CouldNotGenerateCronExpression extends Noovias_Cron_Exception_Abstract
{
