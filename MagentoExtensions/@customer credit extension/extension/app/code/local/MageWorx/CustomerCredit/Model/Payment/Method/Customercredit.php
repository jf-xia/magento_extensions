...
class MageWorx_Customercredit_Model_Payment_Method_Customercredit extends Mage_Payment_Model_Method_Abstract
{
    ...
    /*public function getTitle()
    {
        ...
        return 'Internal credit ('.Mage::helper('core')->currency($credit).' available)';
    }*/
    ...
    public function isAvailable($quote=null)
    {
        ...
        if(Mage::getSingleton('admin/session')->getUser() && $credit < ($address->getGrandTotal() + $address->getCustomerCreditAmount())){
            return false;
        }
