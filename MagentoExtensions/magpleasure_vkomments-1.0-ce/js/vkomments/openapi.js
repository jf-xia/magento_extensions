  ...
  VK.Api = {
    ...
    checkMethod: function(method, params, cb, queryTry) {
      switch(method.toLowerCase()) {
        case 'wall.post':
          var box = VK.Util.Box('http://vk.com/apps.php?act=a_prepare_post&widget=1&aid='+parseInt(VK._apiId)+'&owner_id='+parseInt(params['owner_id'] || 0)+'&attachment='+(params['attachment'] || '')+'&text='+encodeURIComponent(params['message']), [460, 220], {
        ...
        break;
        case 'activity.set':
          var box = VK.Util.Box('http://vk.com/apps.php?act=a_prepare_post&widget=1&aid='+parseInt(VK._apiId)+'&text='+encodeURIComponent(params['text']), [460, 220], {
            proxy: function (hash, error) {
			        if (error) {
				        cb({error: error})
			        } else {
				        params['method_force'] = true;
                VK.Api.call(method, params, cb, queryTry);
			        }
            }
          });
