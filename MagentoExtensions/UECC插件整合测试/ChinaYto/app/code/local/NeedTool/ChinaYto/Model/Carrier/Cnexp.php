...
class NeedTool_ChinaYto_Model_Carrier_Cnexp extends Mage_Shipping_Model_Carrier_Abstract
{
    protected $_code  = 'ChinaYto_cnexp';
    protected $_result;
  ...
  public function collectRates(Mage_Shipping_Model_Rate_Request $request)
  {
		...
		if ( $freefrom >0 && $package_value_with_discount <= $freefrom ) {
			$fee = $package_value_with_discount * 0.10; // base currency
