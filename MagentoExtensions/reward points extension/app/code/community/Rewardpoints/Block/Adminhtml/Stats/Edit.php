 ...
 */
class Rewardpoints_Block_Adminhtml_Stats_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_formScripts[] = "
            ...
            checkTarget = function(){
                if ($('target_type').getValue() == ".Rewardpoints_Model_Stats::TARGET_FREE."){
                    $('order_id').value = '".Rewardpoints_Model_Stats::APPLY_ALL_ORDERS."';
                    $('order_id').up(1).hide();
                } else {
                    $('order_id').value = '';
                    $('order_id').up(1).show();
