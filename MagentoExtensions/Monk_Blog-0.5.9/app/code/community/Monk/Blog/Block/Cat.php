<?php
class Monk_Blog_Block_Cat extends Mage_Core_Block_Template
{
    public function getPosts()
   	{	
		...
		else
		{
			...
			$posts->setPageSize((int)Mage::getStoreConfig('blog/blog/perpage'));
			...
			foreach ($posts as $item) 
			{
				...
				$item->setCreatedTime($this->formatDate($item->getCreatedTime(),Mage::getStoreConfig('blog/blog/dateformat')));
				$item->setUpdateTime($this->formatDate($item->getUpdateTime(),Mage::getStoreConfig('blog/blog/dateformat')));
