...
");
$installer->run("
DROP TABLE IF EXISTS {$this->getTable('blog_store')};
CREATE TABLE {$this->getTable('blog_store')} (
`post_id` smallint(6) unsigned,
`store_id` smallint(6) unsigned
) ENGINE = InnoDB DEFAULT CHARSET = utf8;

DROP TABLE IF EXISTS {$this->getTable('blog_cat_store')};
CREATE TABLE {$this->getTable('blog_cat_store')} (
`cat_id` smallint(6) unsigned ,
`store_id` smallint(6) unsigned
) ENGINE = InnoDB DEFAULT CHARSET = utf8;

DROP TABLE IF EXISTS {$this->getTable('blog_post_cat')};
CREATE TABLE {$this->getTable('blog_post_cat')} (
`cat_id` smallint(6) unsigned ,
`post_id` smallint(6) unsigned
) ENGINE = InnoDB DEFAULT CHARSET = utf8;
");
