...
class MageWorx_Adminhtml_Block_Customercredit_Customer_Edit_Tab_Customercredit_Adjust extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $creditValue = Mage::helper('customercredit')->getCreditValue($model->getId(), $model->getWebsiteId());
        ...
        $fieldset->addField('credit_value', 'hidden', array(
            'name'     => 'credit_value',            
            'after_element_html' => '</td></tr><tr><td class="label">'.Mage::helper('customercredit')->__('Current Balance').'</td><td class="value">'.Mage::helper('core')->currency($creditValue),
        ));                
