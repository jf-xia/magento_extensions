 ...
 */
class Santhosh_Export_Block_Adminhtml_Category_Export_Categories extends Santhosh_Export_Block_Adminhtml_Category_Export
{
	...
	public function getCsvData($opt = '') {
		if ($opt == 'all') {
			if (is_null($this->_csvData)) {
				$collection = Mage::getModel('santhosh_core/attribute')->getCollection()
						->addCatalogEav()
			...
			return Mage::helper('santhosh_core/category')->getAttributes();
		}
	}
