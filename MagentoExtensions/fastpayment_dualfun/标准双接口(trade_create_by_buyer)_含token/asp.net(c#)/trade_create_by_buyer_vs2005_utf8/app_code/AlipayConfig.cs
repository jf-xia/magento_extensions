...
namespace Com.Alipay
{
    ...
    internal class Config
    {
        ...
        static Config()
        {
            ...
            return_url = "http://127.0.0.1:48329/trade_create_by_buyer_vs2005_utf8/return_url.aspx";

            //服务器通知的页面文件路径 要用 http://格式的完整路径，不允许加?id=123这类自定义参数
            notify_url = "http://www.xxx.com/trade_create_by_buyer_vs2005_utf8/notify_url.aspx";
