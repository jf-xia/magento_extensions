...
class Php4u_BlastLuceneSearch_Model_BlastLuceneSearch extends Mage_Core_Model_Abstract
{
    ...
    public function __construct($_5e8a223a326d56b27e0cf4413f58671f = array())
    {
        if (isset($_5e8a223a326d56b27e0cf4413f58671f['store'])) {
            if ($_5e8a223a326d56b27e0cf4413f58671f['store'] instanceof Mage_Core_Model_Store)
                $this->setStoreId($_5e8a223a326d56b27e0cf4413f58671f['store']->getId());
        }
    ...
    public function getIndexFolder($_3244265c4828307734a3f62db0233e1d = true)
    {
        ...
        if (!is_dir($_57583ceaaf7f2d0b967c7b29cd4e30a7)) {
            ...
            if (stripos(PHP_OS, 'win') === FALSE) {
                $_ab4a866184a9dcf08d2460d56ccf6721 = array(
                    'name' => 'apache',
                    'gecos' => 'apache'
                );
    ...
    public function removeAll()
    {
        ...
        for ($_c85e48c002c8d0ceda2f972327e78ee5 = 0; $_c85e48c002c8d0ceda2f972327e78ee5 < $this->getIndex()->maxDoc(); $_c85e48c002c8d0ceda2f972327e78ee5++) {
    ...
    {
        if (!in_array($_8b120a39ecd123195c08fdb025b8424d, array(
            'product_name',
            'product_sku',
            'product_description',
    ...
    public function addProductToIndex($_684842bcb895b7bec57b6015cc62a5fb, $_66ecc94926fccf958c92539841d8a518, $_c7e63446d2038675c2d4c2e15b9b0793 = false, $_0931fc9ddef0d26a1e96967a8ff9922f = true)
    {
        ...
        if (TRUE === $_0931fc9ddef0d26a1e96967a8ff9922f)
            $this->getIndex()->commit();
        if (!$_c7e63446d2038675c2d4c2e15b9b0793) {
            $this->markAsIndexNotRequired($_684842bcb895b7bec57b6015cc62a5fb);
        }
    ...
    public function markAsIndexRequired($_506d7ca1425a89cd2fb52f63efca0cf5)
    {
        if ($_506d7ca1425a89cd2fb52f63efca0cf5 > 0 && $this->getStoreId() > 0 && $this->_getAttributeId() !== false) {
            $_5e4dc48878a719586fd1017a3094b0c5 = array(
                ...
                Mage::getResourceModel('eav/entity_attribute')->getIdByCode('catalog_product', 'lucene_indexed'),
                $this->getStoreId(),
                $_506d7ca1425a89cd2fb52f63efca0cf5,
                0
            );
    ...
    public function cleanString($_2b86beb1e6bcf66c76c107f428c5c728)
    {
        ...
        $_e2cfc64703f40b5a93c0de15ab5fe9bc = array(
            '&' => 'and'
        );
        ...
        if (!empty($_cf0e3221ff72a61c5a01244bd5f74ab2)) {
            ...
            for ($_2ded5c622c934a71410e4681cfff8291 = 0; $_2ded5c622c934a71410e4681cfff8291 < strlen($_cf0e3221ff72a61c5a01244bd5f74ab2); $_2ded5c622c934a71410e4681cfff8291++) {
    ...
    private function _processHits($_b1526cc4b285e2c8e10f38a5b6acc689)
    {
        ...
        Mage::dispatchEvent(Php4u_BlastLuceneSearch_Model_Event::EVENT_PROCESS_HITS, array(
            'results' => $_d4c14c443314a71d8979e282c218a4eb
        ));
        return $_d4c14c443314a71d8979e282c218a4eb;
    }
    public function getResultsWithScore($_87ddbbd24fb086dbd3694acd998ed20a)
    {
        ...
        if (empty($_a0764124f9fafd9237a5ea9ebf7a7c76) && Mage::getStoreConfigFlag('php4u/php4u_group/php4u_no_results_enabled', $this->getStoreId())) {
            ...
            if (strlen($_569f74676b1bc67f93ee8c2aec004568) > 0) {
                ...
                for ($_2ded5c622c934a71410e4681cfff8291 = 0; $_2ded5c622c934a71410e4681cfff8291 < strlen($_569f74676b1bc67f93ee8c2aec004568); $_2ded5c622c934a71410e4681cfff8291++) {
    ...
    public function getResultsForApi($_87ddbbd24fb086dbd3694acd998ed20a, $_c1ca93eaa23ff172f14a57ff40842925 = '300')
    {
        ...
        $_13766f5f245587c0c606f17149bce92a = Mage::getModel('catalog/product')->getCollection()->addStoreFilter($this->getStoreId())->addAttributeToSelect('name')->addAttributeToSelect('image')->addMinimalPrice()->addFinalPrice()->addFieldToFilter('entity_id', array(
            'in' => array_keys($_a0764124f9fafd9237a5ea9ebf7a7c76)
        ));
        foreach ($_13766f5f245587c0c606f17149bce92a as $_4d4786c90bc462bbef64b33271398a88) {
            if (!$_4d4786c90bc462bbef64b33271398a88) {
                continue;
            }
            $_1c8c60a34605501165604df86fb932b2[$_a0764124f9fafd9237a5ea9ebf7a7c76[$_4d4786c90bc462bbef64b33271398a88->getId()] * 100000] = array(
                'product_id' => $_4d4786c90bc462bbef64b33271398a88->getId(),
                'sku' => $_4d4786c90bc462bbef64b33271398a88->getSku(),
                'name' => $_4d4786c90bc462bbef64b33271398a88->getName(),
                'set' => $_4d4786c90bc462bbef64b33271398a88->getAttributeSetId(),
                'type' => $_4d4786c90bc462bbef64b33271398a88->getTypeId(),
                'category_ids' => $_4d4786c90bc462bbef64b33271398a88->getCategoryIds(),
                'full_url' => $_4d4786c90bc462bbef64b33271398a88->getUrlInStore(),
                'image_url' => (string) Mage::helper('catalog/image')->init($_4d4786c90bc462bbef64b33271398a88, 'image')->resize($_c1ca93eaa23ff172f14a57ff40842925),
                'price' => $this->_getPrice($_4d4786c90bc462bbef64b33271398a88) == 0 ? $_4d4786c90bc462bbef64b33271398a88->getPrice() : $this->_getPrice($_4d4786c90bc462bbef64b33271398a88),
                'final_price' => $_4d4786c90bc462bbef64b33271398a88->getFinalPrice()
            );
        }
    ...
    private function _getPrice($_4d4786c90bc462bbef64b33271398a88)
    {
        ...
        if ($_4d4786c90bc462bbef64b33271398a88->getPriceType() == 1) {
            ...
            if ($_weeeTaxAmount && Mage::helper('weee')->typeOfDisplay($_4d4786c90bc462bbef64b33271398a88, array(
                0,
                1,
                4
            ))) {
            ...
            if (Mage::helper('weee')->typeOfDisplay($_4d4786c90bc462bbef64b33271398a88, array(
                1,
                2,
                4
            ))) {
    ...
    private final function _prepareApp()
    {
        if (empty(self::$_lic)) {
            ...
            $_7b426c5b5b5b3868fd0c4bbbc2a99478 = array(
                'HTTP_HOST' => $_5d0fd7661ca9099a8db4c05ad4896a11['host'],
                'SERVER_NAME' => $_5d0fd7661ca9099a8db4c05ad4896a11['host']
            );
            ...
            if (@!file_exists($_55574d3e4430ed2087ec849f8a72662a) || @!is_file($_55574d3e4430ed2087ec849f8a72662a) || @!file_exists($_acc750ac528070ebc970dc68de405c04) || @!is_file($_acc750ac528070ebc970dc68de405c04))
                throw new Exception("Blast Search Lucene module corrupted / some files missing");
            ...
            self::$_lic = $this->application->validate($this->_getLicData());
    ...
    final public function isLicValid()
    {
        ...
        if (isset(self::$_lic['RESULT'])) {
            return true;//(self::$_lic['RESULT'] == base64_decode('T0s='));
        }
        return true;
    }
    public final function getLicInfo()
    {
        ...
        if (isset(self::$_lic['DATE']['HUMAN']['START']))
            $_5a46660f468b88d281d370fea8f3fc2e .= '<p>Start date: <strong>' . self::$_lic['DATE']['HUMAN']['START'] . '</strong></p>';
        if (isset(self::$_lic['DATA']['type']) && self::$_lic['DATA']['type'] === base64_decode('dHJpYWw=')) {
            ...
            if (isset(self::$_lic['DATE']['HUMAN']['END']))
                $_5a46660f468b88d281d370fea8f3fc2e .= '<p>Expire: <strong>' . self::$_lic['DATE']['HUMAN']['END'] . '</strong></p>';
