...
class Mage_Adminhtml_Model_Session_Quote extends Mage_Core_Model_Session_Abstract
{
     ...
     */	
	    ...
	    {
	    	if ((Mage::getSingleton('customer/session')->getEditOrder()!=null)&&(Mage::getModel('checkout/cart')->getQuote()!=null)) {
		    		$this->_quote = Mage::getModel('checkout/cart')->getQuote();
	    	}
	        elseif (is_null($this->_quote)) {
	    	...
	    	if ((Mage::getSingleton('customer/session')->getPayOrder()!=null)) {
		    		$this->_quote = Mage::getModel('checkout/cart')->getQuote();
	    	}
	        return $this->_quote;
	    }
