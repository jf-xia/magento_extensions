 ...
 */
class Soon_AdvancedCache_Block_Adminhtml_Symlink extends Mage_Adminhtml_Block_Template {

    protected $_symlinkCacheClass = 'Soon_AdvancedCache_Model_Symlink';

    protected function _prepareLayout() {
        parent::_prepareLayout();
        if ($this->isSymlinkCacheInUse()) {
            $this->setChild('initSymlinksButton', $this->getLayout()->createBlock('adminhtml/widget_button')
                            ->setData(array(
...
<config>
	<global>
		<cache>
			<backend>Soon_AdvancedCache_Model_Symlink</backend>
			<backend_options>
...
<config>
	<global>
		<cache>
			<slow_backend>Soon_AdvancedCache_Model_Symlink</slow_backend>
		</cache>
	</global>
</config>
EOT;
